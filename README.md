...
Warning: The full dataset is massive (over 3GB). You are not expected to process the entire file. You should filter the data early and create a single working dataset with about 500,000 rows and the relevant columns for the analysis.
